...
export type AnimeTitleQueryVariables = Exact<{ [key: string]: never; }>;


export type AnimeTitleQuery = { __typename?: 'Query', Media?: { __typename?: 'Media', title?: { __typename?: 'MediaTitle', english?: string | null } | null } | null };


export const AnimeTitleDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AnimeTitle"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"Media"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"type"},"value":{"kind":"EnumValue","value":"ANIME"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"english"}}]}}]}}]}}]} as unknown as DocumentNode<AnimeTitleQuery, AnimeTitleQueryVariables>;